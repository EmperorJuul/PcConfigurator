...
public class CpuDto {
    ...
    public CpuDto(Long id, String brand, String productLine, int generation, int tier, int modelNumber, String suffix, String socket, boolean hasIGpu, List<Pc> pcList) {
        this.id = id;
        this.brand = brand;
